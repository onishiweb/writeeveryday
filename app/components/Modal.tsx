    ...
    return (
        <div className={`Modal ${isOpen ? "Modal--open" : ""}`}>
            <div className="p-8 max-w-[90%] md:max-w-1/2 rounded-md bg-white text-black relative z-10 overflow-visible">
                ...
                <p>There is no requirement to submit your writing each day, but if you want to share you can do so via the <a href="">Discord server</a> or you could use one of the many writing subreddits.</p>
          </div>
